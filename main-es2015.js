...
const routes = [
    { path: '', component: _portfolio_portfolio_component__WEBPACK_IMPORTED_MODULE_3__["PortfolioComponent"] }
];
...
let PortfolioComponent = class PortfolioComponent {
    constructor() {
        this.appConfig = _app_config__WEBPACK_IMPORTED_MODULE_2__["APP_CONFIG"];
    }
    ngOnInit() {
    }
};
...
module.exports = __webpack_require__(/*! C:\Dev\khoanguyen.github.io\src\src\main.ts */"./src/main.ts");
